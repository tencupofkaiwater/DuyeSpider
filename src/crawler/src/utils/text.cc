...
bool matchContentType (const char *ct) {
  int i=0;
...
bool matchPrivExt (const char *file) { return false; }
bool matchContentType (const char *ct) { assert(false); return true; }

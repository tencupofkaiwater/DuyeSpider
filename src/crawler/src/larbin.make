...
MAIN-OBJ:=global.o startup.o crawler.o crawler_page.o
...
INCLUDE := -I../ -I../inc -I$(SPIDER_ROOT)/inc -I$(BASEDIR) -I$(ADNSDIR)
LIBS += -ldposix
LIBPATH := 

#CFLAGS:=-O3 -Wall -D_REENTRANT

CXXFLAGS:= -Wno-deprecated -Wall -O3 -D_REENTRANT -iquote $(INCLUDE) $(LIBS) $(LIBPATH)
